...
Tab:AddButton({
    Name ="无敌少侠",
    Callback = function()
    loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-252-Invinicible-Flight-R15-45414"))()
    end
})
...
Tab:AddButton({
    Name ="防摔",
    Callback = function()
    loadstring(game:HttpGet("http://rawscripts.net/raw/Universal-Script-Touch-fling-script-22442"))()
    end
})
